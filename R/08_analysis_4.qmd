...
```{r}
ggsave(filename = here("results/08_keyplot_a.png"), plot = p1, width = 8, height = 4, dpi = 300, bg = "white")  
ggsave(filename = here("results/08_keyplot_b.png"), plot = p2, width = 8, height = 4, dpi = 300, bg = "white")
ggsave(filename = here("results/08_keyplot_c.png"), plot = p3, width = 8, height = 4, dpi = 300, bg = "white")
```
