...
p0 <- group_counts |>
  ...
  labs(
    ...
    y = "Number of peopled died after x days"
  ) 
  
# Save the plot as a PNG
ggsave("../results/overall.png", plot = p0, dpi = 300)
...
# Save the plot as a PNG
ggsave("../results/ischaemic_stroke_td.png", plot = p1, dpi = 300)
...
# Save the plot as a PNG
ggsave("../results/pulmonary_td.png", plot = p6, dpi = 300)
```
