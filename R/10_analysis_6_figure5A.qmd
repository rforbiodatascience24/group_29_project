...
The numbers here seems to fit the numbers from figure 5.A to the extent that it can be read. XXX
...
sorted_data |>   
  ...
  geom_errorbar(position = position_dodge(width = 0.9),
                width = 0.3) +
  labs(title = "Percentage of patients with XXX",
       subtitle = "XXX",
       x = NULL,
       y = "%",
       fill = "Aspirin Dosing") +
